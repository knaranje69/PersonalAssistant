...
def display_current_time():
    # Get the current time in local timezone (e.g., India/Delhi)
    local_timezone = pytz.timezone('Asia/Kolkata')  # Adjust to your local timezone
...
while True:
    ...
    if 'time' in question.lower():
        ...
        formatted_time = display_current_time()
